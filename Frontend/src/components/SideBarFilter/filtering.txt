      ...
      <section className="sideFilter">
        <div className="card border-0 shadow">
          ...
          <div className="catList cursor">
            {[
              {
                icon: <TbFridge size={18} />,
                cat: "Food",
                count: 30,
              },
              {
                icon: <GiScaleMail size={18} />,
                cat: "Clothes",
                count: 22,
              },
              {
                icon: <MdPhonelink size={18} />,
                cat: "Electronics",
                count: 28,
              },
              {
                icon: <GiConverseShoe size={18} />,
                cat: "Shoes",
                count: 42,
              },
              {
                icon: <GiHeartNecklace size={18} />,
                cat: "Jwellary",
                count: 56,
              },
              {
                icon: <GiSchoolBag size={18} />,
                cat: "Bag",
                count: 20,
              },
              {
                icon: <TbMoodKidFilled size={18} />,
                cat: "Kids",
                count: 20,
              },
              {
